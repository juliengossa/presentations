...
save(carto_dataESR, file = "carto_dataESR.RData")
```
...
ggplot(carto_dataESR) + geom_bar(aes(x=couv_tempo_gp, fill = theme_jdd)) +
  scale_x_discrete("Couverture temporelle des jeux de données", limits = c("Inférieure ou égale à 1 an", "2-5 ans", "6-10 ans", "Supérieure à 10 ans")) +
