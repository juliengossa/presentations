...
personnels %>% 
  ...
  labs(title = "Taux de titularité des personnels", subtitle = "E-EC et BIATSS du MESRI, et Opérteurs nationaux de recherche (ONR)", caption = "Source : SIES https://data.enseignementsup-recherche.gouv.fr")
```
