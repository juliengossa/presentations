...
personnels %>% 
  ...
  labs(title = "Taux de titularité des personnels", subtitle = "E-EC et BIATSS du MESRI, et Opérteurs nationnaux de recherche (ONR)", caption = "Source : SIES https://data.enseignementsup-recherche.gouv.fr")
```
...
personnels %>% 
  ...
  labs(title = "Taux de titularité des personnels (valeur 100 en 2015)", subtitle = "E-EC et BIATSS du MESRI, et Opérateurs nationnaux de recherche (ONR)", caption = "Source : SIES https://data.enseignementsup-recherche.gouv.fr")
```
