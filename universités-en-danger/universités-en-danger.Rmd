...
- Le rôle historique définit après-guerre (massification + production scientifique) est révolu.
- Le rôle définit au tournant du XXIe (insertion pro + Excellence) peine à faire sens.

#### Besoin urgent d'une refondation

- En sortant des postures et défenses d'intérêts particuliers.
