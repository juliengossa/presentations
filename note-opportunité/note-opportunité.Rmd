...
bibliography: 
  - Opportunité stratégique - Modèle économique.bib
  - Etudes empiques.bib
biblio-style: verbose
date: |
  | `r Sys.Date()` (v1.7.0)
  | [ [Télécharger la version la plus récente](https://github.com/juliengossa/presentations/blob/main/note-opportunit%C3%A9/note-opportunit%C3%A9.pdf) ]
---
...
Ce mouvement n'est pas spécifique à la France, mais se retrouve notamment aux États-Unis, où l’éduscepticisme fait désormais partie du débat public [@minbahadurbistaHigherEducationScepticism2026], et participe déjà à « _transformer l'enseignement supérieur_ »[@whiteEnrollmentCliffHow]. La défiance de l’administration Trump est particulièrement vive[@johnoliverTrumpVsHigher2025], et a sans doute participé à sa victoire électorale, en désignant les universités comme l'ennemi de la nation : « _The universities are the enemy_ »[@laurenlassabeshepherdUniversitiesAreEnemy2025]. Aux USA comme en Angleterre, on affirme qu'« _Il est temps de réaliser que l’Université est une arnaque_ »[@bootleItsTimeBritain2025], position relayée en France sans distance dans Le FigaroVox[@emmabeckerJaimaisBeaucoupCharlie2025]. 
...
De fait, une approche purement utilitariste des études supérieures oblige à questionner le retour sur investissement des études face aux révolutions du marché du travail : en ce moment, il faut prédire les secteurs qui seront impactés par l'IA demain pour savoir quelles sont les filières encore rentables aujourd'hui[@murrayAIsRapidEvolution2025] ; certains s'inquiètent même que cela pourrait représenter la fin de l'université de masse[@nicolaifossWirdKIEnde2025]. Plus globalement, l'intérêt d'apprendre est aujourd'hui remis en cause par l'arrivée de l'IA[@gaultWhatsPointSchool2026].
...
Depuis 2010, la croissance du secteur privé (+76 %) se détache de celle du secteur public (+15 %). Une partie de ces chiffres 
...
Le rapport « Démographie et finances publiques »[@courdescomptesDemographieFinancesPubliques2025] de la Cour des comptes démontre que les effectifs étudiants sont portés par un double-effet démographie et augmentation du taux de poursuite d'étude, mais qui arrive à son terme. Le rapport « Des écoles au marché du travail : la marée descendante de la dénatalité »[@maximesbaihiEcolesAuMarche2025] estime que « _La dénatalité devrait impacter les effectifs de l’enseignement supérieur à partir de 2029, avec une baisse plus prononcée à partir de 2033_ ». Nous amorçons désormais une chute mécanique du nombre d'étudiants, dont on ne connaît pas encore l'ampleur ni la durée puisque la natalité continue de baisser en 2025. Les universitaires actuels pourraient bien terminer leur carrière en ne connaissant plus qu'une baisse des effectifs étudiants.
...
Le rapport OCDE de 2008 « L'enseignement supérieur à l'horizon 2030 »[@ocdeLenseignementSuperieurLhorizon2008] souligne que « _la contraction des systèmes est un phénomène nouveau, qui correspond à  une saturation ou à une stagnation des taux d’entrée combinée à une décroissance des jeunes cohortes_ ». S'il s'intéresse à la démographie, le rapport Draghi[@mariodraghiDraghiReportEU2024] s'inquiète plus des pénuries de mains d'œuvre que de l'impact sur l'enseignement supérieur. Pourtant, les USA semblent entrer dans cette phase de contraction, avec la fermeture de 2% des établissements[@moodyReportFindsHigher2024], mais qui inquiète moins que les fermetures de filières[@dickstartzAreCollegesReally2024]. Sans immigration, la population étudiante américaine pourrait baisser de 30 % à 40 %, ce qui serait « _catastrophique pour de nombreuses universités_ »[@zavodnyImportanceImmigrantsInternational2025]. La Corée du sud a déjà fait face à la rencontre entre une massification éducative et une réduction démographique, « _un problème sérieux pour les institutions, les communautés locales et l'économie_ »[@jungWhenMassifiedHigher2024]. Maintenir le nombre d'institutions et de programmes a été impossible et la diversité du système s'est apauvrie, malgré différentes politiques de restructuration élaborées par l'État coréen pour éviter un écroulement. 

En France, pour percevoir la prise en compte de la démographie dans les politiques publiques, la Cour des comptes s'est livrée à une analyse lexicographique concluant que « _les rapports annexés aux projets de loi de programmation des finances publiques (premier corpus) ou bien les exposés des motifs des lois de programmation sectorielles (troisième corpus) ne se réfèrent pratiquement jamais aux enjeux démographiques. Ce résultat peut apparaître surprenant concernant des textes touchant par exemple à l’enseignement supérieur_ »[@courdescomptesDemographieFinancesPubliques2025].

En l'absence de startégie nationale, et face à la baisse programmée du nombre d'étudiants, les premières stratégies locales d'adaptation commencent à être établies[@malikabutzbachBaisseDemographiqueComment2025] [@ameliepetitdemangeLISCMiseLinnovation2025] [@ameliepetitdemangeFaceBaisseNombre2025]. On peut les classer en trois catégories :
...
Pour conclure, il est tout à fait possible que la France, au même titre que toutes les nations ayant procédé à leur massification éducative, soit désormais face à un nouveau choix, de l'ampleur de celui qui a été fait après-guerre, concernant le rôle que doit jouer son enseignement supérieur et plus particulièrement son Université. Le rapport « _Universities and competitiveness_ » de l'EUA[@anna-lenaclaeys-kulikUniversitiesCompetitiveness2025] estime que, face à la « _polycrise_ », il est devenu prioritaire pour chaque université de repenser son rôle et ses missions. 
L'idée s'impose progressivement : « _le débat, compliqué et sensible politiquement, sur le périmètre du service public de l’enseignement supérieur en tant que bien collectif ne peut être éludé_ »[@christian-lucienmartinRapportIGFIgesr2025]. Cette question ne peut être séparée de la question plus large de la croyance en la méritocracie dans notre société, qui apparait comme de moins en moins évidente[@wiesnerEffortAdvantageVisualizing2026].

Pour l'instant, ce débat est mené de façon confidentielle et sectorielle, par exemple pour les universités et la recherche[@michelebargielLancementLAsurReseau2025], par l'Initiative[@linitiativePourNouveauPacte2025] ou pour les écoles d'Art[@valentinchomienneMarseilleEcolesDart2025]. Le manifeste québécois « rallumer le phare »[@rallumerlephareCinqEngagements2025] montre que le débat se pose dans les mêmes termes à l'international. Plus globalement, l'inflation sans priorité des missions officielles de l'enseignement supérieur est de plus en plus remise en cause [@kenzaoccanseyInvestirDansLavenir2025] [@laurencegarnierRelationsStrategiquesEntre2025] [@brunobouchardEstTempsSe2025] . L'évolution du L123.2 du code de l'éducation^[Article L123-2 du Code de l'éducation entre 2000 et 2025. www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000042815070] (voir ci-dessous) est effectivement parlante. Malheureusement, le cadrage des assises du financement des universités, annoncé en janvier 2026 [@philippebaptisteLancementAssisesFinancement2026], évite d'aborder cette question. __Pourtant, tôt ou tard, il arrivera le moment où on ne pourra plus faire l'économie d'une révision et d'une hiérarchisation des missions de l'enseignemetn supérieur, et d'une révision de leur ventilation parmis les acteurs existants.__
...
## L'influence des frais d'inscription sur le comportement des étudiants ne fait pas consensus, est hautement liée à de nombreux autres paramètres, et nécessite des enquêtes nationales avant d'être mobilisée.

Deux argument sont fréquemment avancés en faveur des frais d'inscription : le signal-prix et le coût irrécupérable. En défaveur des frais d'inscription, on avance plus souvent le risque de diminuer le taux de poursuite d'études.

Le signal-prix est invoqué dans le discours supposant que la gratuité contribue à une perception négative de la qualité des formations universitaires : « ce qui n'a pas de prix n'a aucune valeur ». Les études empiriques sur le sujet montrent des résultats contrastés. Au Royaume-Uni, le prix est effectivement perçu comme un indicateur de qualité, mais non-linéaire et beaucoup plus faible que d'autres facteurs tels que la réputation, le taux de sélection, ou la position géographique[@sooDoesPriceMatter2010]. Aux USA, les établissements développent des stratégies d'affichage tarifaire destinés à biaiser le marché[@cheslock2021]. Une vaste enquête menée en Allemagne en 2006 montre que seuls 2 % des bacheliers considèrent le tarif comme un indicateur de qualité[@heineStudiengebuehrenAusSicht2008], alors qu'une autre étude montre qu'une augmentation de la perception de la qualité a accompagné l'augmentation des tarifs, mais sans pouvoir l'attribuer à cette hausse en soi[@gawellek2016]. Les études sur les MOOCS, dont le marché est particulier puisque moins contraint géographiquement et plus facile à mesurer, confirment ces contrastes, avec une corrélation inexistante, voire inverse, entre le prix et l'évaluation de la qualité[@shiDecodingDynamicsKnowledge2024, @sakdavongEffectOnlineTraining2023].

__Finalement, il se dégage des études empiriques que les familles considèrent le prix comme un indicateur de qualité seulement lorsque le marché éducatif est organisé de telle façon à ce que le prix soit effectivement un indicateur raisonnable de qualité [@coelen2007] (ce que ne peut pas être un tarif national homogène par niveau d'étude).__

Le coût irrécupérable (_sunk cost_) est invoqué dans le discours supposant que tarifer les études augmente la motivation et la réussite des étudiants : les frais d'inscription étant irrécupérables, les étudiants travailleraient plus sérieusement dans l'objectif de rentabiliser leur investissement. Cependant, les études empiriques montrent là également des effets contrastés, positifs en Italie[@garibaldi2012] et en Espagne[@beneito2018], mais insignifiants au Pays-Bas[@ketel2016], en Suisse[@fricke2018] et au Chili[@espinoza2025]. Une étude sur les MOOCS montrent que cet effet ne dure en réalité que quelques semaines[@goli2022]. Finalement, dans les systèmes tarifés, la réussite est moins corrélée avec les tarifs qu'avec les bourses [@nguyenEffectsGrantAid2019, @lasotaDoesAidMatter2025], à condition qu'elles soient accessibles à un grand nombre plutôt que réservées aux étudiants les plus performants [@lintnerEffectsPerformancebasedFinancial2024]. 


Concernant les taux de poursuite, les études empiriques montrent aussi des résultats contrastés, allant d'un effet nul [@havranekTuitionFeesUniversity,@bruckmeier2014], en passant par un effet légèrement positif d'une baisse des tarifs[@wardResettingPricesEstimating2023] ou un effet négatif très important d'une hausse des tarifs, en particulier en Allemagne au moment de l'introduction de ces frais[@bahrsUniversityTuitionFees2019,@hubnerTuitionFeesAffect2012]. Une étude allemande constate cependant que des frais à prix-coutants n'ont pas d'impact sur le taux global de diplômation[@bietenbeckTuitionFeesEducational2023], la diminution du taux d'engagement étant compensée par une hausse de la réussite.

En France, nous manquons d'études empiriques. Les travaux de doctorat de Léonard Moulin à Paris Dauphine montrent cependant que l'introduction de frais d'inscription ont renforcé les ségrégations et les inégalités, sans augmenter la réussite[@moulinFraisDinscriptionDans2014].

__En conclusion, les effets du signal-prix et du coût irrécupérable sont au mieux secondaires. Surtout, ils sont très dépendant du système dans lequel on les met en place. C'est pourquoi il conviendrait, avant de les invoquer, de mener une enquête pour quantifier la perception des lycéens et de leur famille, similaire à celle menée en Allemagne lorsqu'elle a cherché à augmenté ses frais d'inscription[@heineStudiengebuehrenAusSicht2008]. Il conviendrait également d'évaluer les conséquences d'une baisse du taux d'engagement dans un contexte de dénatalité post-massification.__
...
Les modèles économiques généralement pris en exemple de raussite[@dianeschererProgressiviteDroitsScolarite2025] (Sciences Po et Dauphine), parfois appelés « tarification sociale », concernent des établissements qui ne sont absolument pas représentatifs de la majorité des universités. Ils ne sauraient servir sérieusement de modèle généralisable. En particulier, la non-compensation par l’État de l'exonération des boursiers pourrait peser bien plus lourdement sur les universités ordinaires que sur ces établissements. 
