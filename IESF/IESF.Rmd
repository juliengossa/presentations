---
title: "Quelques données sur la recherche"
subtitle: |
    | Audition IESF
...
### Proposition : se retirer de la « compétition scienfique » 

- Sortir de l'« Excellence scientifique »
  - Retrait des classements internationnaux comme nationnaux
  - Sortir de la « compétition » au profit de la collaboration
  - Suppression des « financements compétitifs » (ANR, primes, etc.)
- Viser la sobriété et l'intégrité scientifique 
  - Publier beaucoup moins pour publier mieux.
  - Donc une reconnaissance internationale de la qualité.

### Proposition : Recentrage stratégique sur nos avantages comparatifs

- Faiblesses : peu de moyens, R&D privée en retrait, pilotage stratégique défaillant
- Forces : grande diversité et beaucoup de liberté, habitués à la sobriété
- Assumer une politique de reproduction scientifique dans certains domaines (tech)
- Renforcer les domaines où on est bons (LLA-SHS)
