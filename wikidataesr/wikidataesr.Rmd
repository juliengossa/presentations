...
## Wikidata : une base de donnée semi-structurée libre et ouverte

```{r wd, fig.asp=NULL, out.width="70%", fig.align='center'}
knitr::include_graphics("wd-uga.png")
```

https://www.wikidata.org/wiki/Q945876
