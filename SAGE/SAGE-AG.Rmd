...
## Recherche : Part mondiale des publications scientifiques
...
## Recherche : USA - une évolution brutale.
...
## Recherche : France - Objectifs de la nation = « Excellence scientifique »
...
## Enseignement : Démographie - dénatalité, brutale
...
## Enseignement : Développement rapide de l'edu-scepticisme
...
## Conclusion : Pourquoi investir dans la science ?
...
## Conclusion : Compte rendu de la (micro-)discussion

```{r, out.width="70%", fig.align="center"}
knitr::include_graphics("../ressources/img/AghionCohen-vertu.png")
```

- _Aghion et Cohen, « Education et croissance », 2004._

« [La science] deviendrait quelque chose comme un jeu de société. Certains sujets seraient considérés comme intéressants, d’autres non. Il y aurait des modes. Ceux qui suivraient la mode recevraient des subventions, les autres, non. __Et ils apprendraient tous bien vite à suivre la mode.__ »

- _Léo Szilard, « La voix des dauphins », 1962._
