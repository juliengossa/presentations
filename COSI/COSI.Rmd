---
title: "Nos Services Publics - Chapitres ESR"
subtitle: |
    | COSI - Café Ouvert Sciences et Ingénierie - Sorbonne Université
author: 
- Julien Gossa \newline 
- Université de Strasbourg, Laboratoire SAGE, NSP, et CPESR  \newline \hspace{3cm} \newline
- https://nosservicespublics.fr/rapport-etat-services-publics-2024 \newline \newline
...
## Cinq constats Nos Services Publics
...
### Constat 3 : (Pas de) Prise en compte des enjeux environnementaux

### Constat 4 : Des missions en inflation et de plus en plus en conflit
...
### Constat 5 : Une territorialisation à l'abandon, et un manque d'intersectionnalité dans les politiques publiques.
...
## Vue d'ensemble du moment historique
...
- Fin de la massification / début de stngnation éducative
- Chute impresionnante et durable de la démographie
- Développement rapide de l'édu-scepticisme

Probablement un moment-pivot civilisationnel

#### Soit vers une phase obscurantiste
...
#### Soit vers une redéfinition du rôle de l'éducation, du savoir et de l'Université
