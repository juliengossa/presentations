---
title: "Massification, Stagnation, Démassification"
subtitle: |
    | GameJam - IUT Robert Schuman
...
## Pilotage : « Excellence scientifique »
...
## Pilotage : Places de formation

```{r, fig.asp=7/16, fig.width=7, out.width="100%", fig.align='center'}
plot_LvsM
```

## Pilotage : NEET (not in employment, education or training)
...
\tiny
Source : [INSEE](https://www.insee.fr/fr/statistiques/serie/010752067#Graphique)


## Pilotage : Investissement vs. Productivité
...
## Pilotage : différencier les couts par formation
...
## Pilotage : investissement à très long terme
...
## Contexte : USA - la science rentable (et un peu barbare)
...
## Contexte : Chine - la science visible
...
# Objectif officiel : Enseignemment supérieur



## Conclusion : Un scénario catastrophe (possible)
