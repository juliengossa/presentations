---
title: "Massification, stagnation éducative, démassification : sommes-nous à l'aube d'un changement de régime éducatif ?"
subtitle: |
    | Séminaire de l'IREDU
...
## Budget de l'ESR : Investissement dans l'ESR (P150 / nombre total d'étudiants)
...
## Budget de l'ESR : Annonces contradictoires

```{r, out.width="55%", fig.align="center"}
knitr::include_graphics("../ressources/img/Presse-Budget-MESR2026.png")
```
\tiny
Source : https://www.enseignementsup-recherche.gouv.fr/fr/l-adoption-de-la-loi-de-finances-pour-2026-concretise-la-priorite-donnee-par-le-gouvernement-l-100872


```{r, out.width="55%", fig.align="center"}
knitr::include_graphics("../ressources/img/Presse-Budget-Déficit2026.png")
```
Source : https://www.radiofrance.fr/franceinter/podcasts/l-info-de-france-inter/l-info-de-france-inter-9135980

## Budget de l'ESR : Annonces contradictoires

```{r, out.width="55%", fig.align="center"}
knitr::include_graphics("../ressources/img/Presse-Budget-LPPR.png")
```
\tiny
Source : https://www.enseignementsup-recherche.gouv.fr/sites/default/files/2021-09/dossier-de-presse-lpr-du-09-septembre-2020-12878.pdf


```{r, out.width="55%", fig.align="center"}
knitr::include_graphics("../ressources/img/Presse-Budget-AssisesFinancement.png")
```
Source : https://www.enseignementsup-recherche.gouv.fr/fr/lancement-des-assises-du-financement-des-universites-100759
...
```{r, fig.asp=7/16, out.width="100%"}
plot_SCSPvsMS
```

Changement de doctrine à partir de 2021-2022 (confirmé par les COMP100%).

## Emplois enseignants-chercheurs
...
# Massification / Stagnation éducative


## Massification éducative (l'illusion)
...
## Stagnation éducative (la réalité)
...
# Vers une démassification éducative ?

## Premier facteur : dénatalité
...
## Deuxième facteur : réduction de la durée des études
...
```{r, out.width = "100%"}
knitr::include_graphics("../ressources/img/Presse-Reussite-DNB.png")
``` 
...
```{r, out.width = "100%"}
knitr::include_graphics("../ressources/img/Presse-Reussite-Bac.png")
``` 
...
# Petit détour : Recherche

## Objectif de la nation - « Excellence scientifique »
...
```{r, out.width="100%", fig.align="center", fig.show='hold'}
  knitr::include_graphics("../ressources/img/PAP-172-2026.png")
```

\tiny
Source : [Projet annuel de performances PLF 2026](https://www.budget.gouv.fr/documentation/documents-budgetaires/exercice-2026)
...
## USA : la science rentable (et un peu barbare)

```{r, out.width="100%", fig.asp=7/16}
plot_rd
```

\tiny
Source : [List of companies by research and development spending](https://en.wikipedia.org/wiki/List_of_companies_by_research_and_development_spending)
...
## Développement d'un dicours édu-sceptique
...
## Développement d'une politique édu-sceptique
...
## Décollage du secteur privé (augmentation de l'offre)
...
## Taux d'engagement (diminution de la demande)
...
## Une solution de régulation : la hausse des frais d'inscription
...
## « La démographie a toujours raison » : des effets imprévisibles
...
## Conclusion : A la croisée des chemins

- Fin de la massification / début de démassification éducative
- Chute impressionnante et durable de la démographie
- « Compétition scientifique » perdue
- Développement rapide de l'édu-scepticisme
- Des effets imprévisibles sur l'emploi des jeunes et les missions de l'ESR

### Soit vers la fin du service public d'ESR

- Individualisation et pure professionalisation des études
- Orientation des recherches exclusivement vers la production de valeurs marchande
...
<!-- NOTE : moins de jeunes, plus d'emplois disponibles, moins de nécessité de rester dans les études. -->


<!-- ======================================================================= -->

## Investissement dans l'ESR (P150 et P172)

```{r, out.width="40%", fig.align="center"}
knitr::include_graphics("../ressources/img/Presse-Budget-RogueESR.png")
```

Infléchissement à partir de 2021-2022.

\tiny Source : https://rogueesr.fr/bonneteau-budgetaire/
