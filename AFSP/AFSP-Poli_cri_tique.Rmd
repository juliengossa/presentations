---
title: "Les moyens de l’ESR : état des lieux et recommandations"
subtitle: |
    | Webinaire Poli(cri)tique #40 - AFSP
...
# Budget de l'ESR : entre insincérité et improvisation
...
## Budget de l'ESR : Improvisation

:::::::::::::: {.columns}
::: {.column width="50%"}
```{r, out.width="100%", fig.align="center"}
knitr::include_graphics("../ressources/img/Presse-Budget-IA.png")
```
:::
::: {.column width="50%"}
```{r, out.width="100%", fig.align="center"}
knitr::include_graphics("../ressources/img/Presse-Budget-ChooseFranceForScience.png")
```
:::
:::::::::::::: 


# Budget de l'ESR : tenter d'y voir clair
...
Inflêchissement à partir de 2021-2022.
...
# Budget de l'ESR : les objectifs officiels
